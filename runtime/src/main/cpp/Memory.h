...
typedef enum {
  ...
  CONTAINER_TAG_OBJECT_COUNT_SHIFT     = 6,
  CONTAINER_TAG_OBJECT_COUNT_MASK     =  0xffff,

  CONTAINER_TAG__SHIFT     = CONTAINER_TAG_OBJECT_COUNT_SHIFT + 16,
  CONTAINER_TAG_OBJECT_COUNT_MASK     =  0xff,
